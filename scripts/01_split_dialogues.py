...
# ========== 配置 ==========
INPUT_JSON = "intermediate/raw_dialogues.json"   # 原始 JSON 文件路径
OUTPUT_DIR = "intermediate/output_cleaning/samples"                        # 输出目录
STATS_DIR = "intermediate/output_cleaning/stats"                           # 统计轮次分布文件目录
PROGRESS_FILE = "intermediate/output_cleaning/progress.txt"                # 进度文件
